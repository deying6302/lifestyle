                ...
                <div class="card border">
                    <div class="card-content">
                        <div class="card-body p-4">
                            <div class="d-md-flex">
                                <div class="my-auto">
                                    <img src="{{ asset('backend/assets/images/wallet.png') }}" alt="author" width="48"
                                        class="my-auto">
                                </div>
                ...
                <div class="card outline-badge-primary">
                    <div class="card-content">
                        <div class="card-body p-4">
                            <div class="d-md-flex">
                                <div class="my-auto">
                                    <img src="{{ asset('backend/assets/images/money.png') }}" alt="author" class="my-auto">
                                </div>
                                <div class="content px-md-3 my-3 my-md-0">
                                    <span class="mb-0 font-w-600 h5">Lorem ipsum dolor sit</span><br>
                                    <p class="mb-0 font-w-500 tx-s-12">Lorem ipsum dolor sit amet, consectetuer adipiscing
                                    ...
                                    <ul class="tasks">
                                        <li class="outline-badge-success border-0 d-flex py-3 px-2 zoom">
                                            <label class="chkbox d-flex">
                                                ...
                                                <img src="{{ asset('backend/assets/images/author2.jpg') }}" alt="author"
                                                    width="30" height="30" class="rounded-circle" />
                                        ...
                                        <li class="outline-badge-warning border-0 d-flex py-3 px-2 zoom">
                                            <label class="chkbox d-flex">
                                                ...
                                                <img src="{{ asset('backend/assets/images/author2.jpg') }}" alt="author"
                                                    width="30" height="30" class="rounded-circle " />
                                                <img src="{{ asset('backend/assets/images/author3.jpg') }}" alt="author"
                                                    width="30" height="30" class="rounded-circle" />
                                        ...
                                        <li class="outline-badge-info border-0 d-flex py-3 px-2 zoom">
                                            <label class="chkbox d-flex">
                                                ...
                                                <img src="{{ asset('backend/assets/images/author3.jpg') }}" alt="author"
                                                    width="30" height="30" class="rounded-circle " />
                                                <img src="{{ asset('backend/assets/images/author7.jpg') }}" alt="author"
                                                    width="30" height="30" class="rounded-circle" />
                                        ...
                                        <li class="outline-badge-secondary border-0 d-flex py-3 px-2 zoom">
                                            <label class="chkbox d-flex">
                                                <input type="checkbox">
                                                <img src="{{ asset('backend/assets/images/author6.jpg') }}" alt="author"
                                                    width="30" height="30" class="rounded-circle " />
                                                <img src="{{ asset('backend/assets/images/author8.jpg') }}" alt="author"
                                                    width="30" height="30" class="rounded-circle" />
                                    ...
                                    <ul class="activities mt-3 mb-2">
                                        <li class="activity py-2 border-left">
                                            <div class="activity-absolute">
                                                ...
                                                <img src="{{ asset('backend/assets/images/author8.jpg') }}" alt="author"
                                                    width="50" class="rounded-circle position-absolute ml-35">
                                            </div>
                                        ...
                                        <li class="activity py-3 border-left">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <img src="{{ asset('backend/assets/images/portfolio1.jpg') }}" alt="photoshop"
                                                    width="100" class="img-responsive rounded">
                                                <img src="{{ asset('backend/assets/images/portfolio2.jpg') }}" alt="photoshop"
                                                    width="100" class="img-responsive rounded ml-2">
            ...
            <div class="col-12  col-md-6 col-lg-4 mt-3">
                ...
                <div class="card promoting-card">
                    ...
                    <div class="card-body d-flex flex-row">
                        ...
                        <!-- Avatar -->
                        <img src="{{ asset('backend/assets/images/author1.jpg') }}" class="rounded-circle mr-3" height="50"
                            width="50" alt="avatar">
