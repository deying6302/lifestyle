function initializeCKEditor(selector, configOverrides = {}) {
    const defaultConfig = {
        toolbar: {
            items: [
    ...
    const editorConfig = Object.assign({}, defaultConfig, configOverrides);

    return CKEDITOR.ClassicEditor.create(document.querySelector(selector), editorConfig);
}
